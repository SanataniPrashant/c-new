//  W.A.P to accept alternate even and odd no. from user and perform sum and print the sum stop when user entered 0.
#include <iostream>
using namespace std;
int main(){
    int number = 0;
    int sum = 0;
    bool is_last_even_number = false; // sugesting last no. is 
    cin >> number;
    sum = sum + number;
    if (number % 2 == 0)
    {
